...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3115866730ltr&server=1">
...
<body>
    <div id="pma_navigation" data-config-navigation-width="239.975">
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=node_blog&table=users">`node_blog`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=worldangular&table=country">`worldangular`.`country`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=worldangular&table=city">`worldangular`.`city`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=konditer&table=user">`konditer`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=konditer&table=zajavka">`konditer`.`zajavka`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=react_school2023&table=users">`react_school2023`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=react_school2023&table=departments">`react_school2023`.`departments`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=konditer&table=regiser">`konditer`.`regiser`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=react_school2023&table=professions">`react_school2023`.`professions`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=post_react&table=users">`post_react`.`users`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="7b6841217672313a2e625d7d435c2838">
...
</span><small>Set to 0 to collapse navigation panel.</small></th><td><input type="number" name="NavigationWidth" id="NavigationWidth" class="custom field-error" value="239.975"><a class="restore-default hide" href="#NavigationWidth" title="Restore default value"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a>
...
<div id="topmenucontainer" class="menucontainer">
  ...
  <div id="pma_console_container">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="node_blog" targettable="">
    ...
    updatedAt datetime
                            ...
                            targetdb="node_blog" targettable="users">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `users` (`id`, `name`, `email`, `password`, `avatarUrl`, `role`, `createdAt`, `updatedAt`) VALUES (NULL, &#039;admin&#039;, &#039;admin@ee.ee&#039;, &#039;$2b$10$YK.LalXd9uyeSV96rqO/cumZqeFn.UyKF/xRp.Ni9fGmOhRd99QPe&#039;, NULL, &#039;admin&#039;, &#039;2023-10-31 14:21:12&#039;, &#039;2023-10-31 14:21:12&#039;), (NULL, &#039;pupil&#039;, &#039;pupil@ee.ee&#039;, &#039;$2b$10$YK.LalXd9uyeSV96rqO/cumZqeFn.UyKF/xRp.Ni9fGmOhRd99QPe&#039;, NULL, &#039;user&#039;, &#039;2023-10-31 14:21:12&#039;, &#039;2023-10-31 14:21:12&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="node_blog" targettable="users">
                            <div class="action_content">

...
# Энергия на выстрел
    ...
    pygame.draw.rect(window, (energy_color_red, energy_color_green, 0), (3, 3, 200 * energy / 200 - 6, 34))
    if energy > 150:
...
# Отрисовка врагов
    ...
    for enemy in meteor_list:
        pygame.draw.rect(window, (30, 30, 30), (enemy[0], enemy[1], enemy[2], enemy[3]))
        enemy[1] += 2
...
# Уничтожение врага
    ...
    text = font.render(str(frag), True, (230, 200, 155))
